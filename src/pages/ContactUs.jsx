  ...
  return (
    <div className="min-h-[80vh] bg-transparent pt-32 pb-24 flex items-center justify-center">
      <div className="max-w-5xl mx-auto px-4 w-full">
        ...
        >
          {/* Address Section */}
          <div className="bg-gray-100 border border-gray-100 p-8 rounded-2xl flex flex-col items-center text-center shadow-lg hover:bg-gray-100 transition-colors">
            <div className="w-14 h-14 bg-berry/20 rounded-full flex items-center justify-center mb-6 text-berry">
              <MapPin size={28} />
            </div>
            <h3 className="font-display text-xl text-gray-900 mb-4">Visit Us</h3>
          ...
          <div className="bg-gray-100 border border-gray-100 p-8 rounded-2xl flex flex-col items-center text-center shadow-lg hover:bg-gray-100 transition-colors">
            ...
            <h3 className="font-display text-xl text-gray-900 mb-4">Email Us</h3>
            <p className="font-body text-gray-500 leading-relaxed text-sm md:text-base italic">
          ...
          <div className="bg-gray-100 border border-gray-100 p-8 rounded-2xl flex flex-col items-center text-center shadow-lg hover:bg-gray-100 transition-colors">
            ...
            <h3 className="font-display text-xl text-gray-900 mb-4">Call Us</h3>
            <p className="font-body text-gray-500 leading-relaxed text-sm md:text-base italic">
