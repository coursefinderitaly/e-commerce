  ...
  return (
    ...
    >
      <div className="text-center px-4">
        <p className="font-display text-[8rem] sm:text-[10rem] text-gray-100 font-bold leading-none">404</p>
        <h1 className="font-display text-3xl md:text-4xl text-gray-900 mt-[-1rem] mb-3">Page Not Found</h1>
