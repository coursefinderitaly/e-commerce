...
src_path = "/home/raag/.gemini/antigravity/brain/40e66e4b-a338-4f64-8e93-46d2633868af/media__1786601750598.jpg"
public_dir = "/home/raag/Desktop/PROJECTS/ecommerce-deepseek/public"

if os.path.exists(src_path):
    img = Image.open(src_path)
    print(f"New Image Format: {img.format}, Size: {img.size}, Mode: {img.mode}")
    
    # Save as PNG to logo1.png and logo1_opt.png
    ...
    # Save as WebP to logo1.webp and logo1_opt.webp
    ...
    print("Successfully replaced all logo files in public/ directory!")
else:
